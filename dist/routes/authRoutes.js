...
router.post('/create-account', (0, express_validator_1.body)('name')
    ...
    .notEmpty().withMessage('E-mail no válido'), validation_1.handleInputErrors, AuthController_1.AuthController.createAccount);
...
router.post('/request-code', (0, express_validator_1.body)('email')
    .notEmpty().withMessage('E-mail no válido'), validation_1.handleInputErrors, AuthController_1.AuthController.requestConfirmationCode);
router.post('/forgot-password', (0, express_validator_1.body)('email')
    .notEmpty().withMessage('E-mail no válido'), validation_1.handleInputErrors, AuthController_1.AuthController.forgotPassword);
...
router.post('/update-password/:token', (0, express_validator_1.param)('token')
    ...
    return true;
}), validation_1.handleInputErrors, AuthController_1.AuthController.updatedPasswordWithToken);
